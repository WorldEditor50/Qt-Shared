...
struct libusb_endpoint_descriptor {
	 ...
	 * corond to \ref libusb_endpoint_transfer_type. Bits 2:3 are only used
	 * for isochronous endpoints and corond to \ref libusb_iso_sync_type.
	 * Bits 4:5 are also only used for isochronous endpoints and corond to
...
typedef enum {
	 ...
	 * It is the user's onsibility to call libusb_close on any handle associated with a disconnected device.
